...
const Amenities = () => {
	function handleRenderPrev(event, isprev) {}
	function handleRenderNext(event, isnext) {}
	return (
		<section className="amenities">
			<Container>
				<Row className="head_cnt">
					...
					<h3>
						When it comes to refined living combined with luxurious
						designs, there is nothing like Luminare.
					</h3>
				</Row>
				<Row>
							...
							<Grid className="page_one page" container spacing={2}>
								<Grid item lg={4}>
									<Stack className="item">
										...
										<p>
											Urban river landscape features &amp; gazebos
										</p>
									</Stack>
								</Grid>
								<Grid item lg={4}>

...
import "./landing.scss";
import landingimg from "../../assets/images/02_Luminare_DigitalBanner_V1_Luminare.jpg";
...
import mb_landing from "../../assets/images/02_Luminare_DigitalBanner_V1_Luminare_M.jpg";
const Landing = (props) => {
    ...
    <div className="header_cnt">
      <div className="landing_img_cnt">
        {viewportWidth > 900 ? (
          ...
          <img className="landing_img" src={mb_landing} alt="landing_img" />
        )}
        {viewportWidth > 900 && <img className="logo" src={logo} alt="logo" />}
      </div>
